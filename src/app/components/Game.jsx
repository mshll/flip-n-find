      ...
      <div className='m-auto flex flex-col items-center justify-center gap-6 font-medium'>
        {isFailed ? (
          <>
            ...
            <p className='text-lg tracking-widest'>You tried your best, but time is over</p>
          </>
        ) : (
          <>
        ...
        <div className='flex gap-6'>
          <Button onClick={() => resetGame()} className='mt-10 border-blue-400 bg-blue-300 font-bold text-slate-800'>
            Play Again
          </Button>
          <Button
            onClick={() => {
  ...
  return (
    <>
      <div className='mx-auto flex min-h-screen flex-col items-center justify-between justify-items-center gap-6 p-10 pb-4 text-center font-[family-name:var(--font-geist-sans)]'>
        ...
        >
          A game by <span className='font-bold'>Meshal</span> & <span className='font-bold'>Saja</span>.
        </p>
      </div>
    </>
  )
